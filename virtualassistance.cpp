...
int main()
{
    ...
    do{
            ...
            system(charCommand);
                        ...
                        cout<<"I am virtual assistant created by my masters poonam and Ashish"<<endl;
                        string phrase=" I am virtual assistant created by my masters poonam and Ashish";
            string command="espeak \" "+ phrase +"\"";
            const char *charCommand=command.c_str();
            system(charCommand);
                    }
                    ...
                    cout<<"Why are cricket stadium so cool?"<<endl<<"because every seat has a fan in it"<<endl;
                    ...
                    cout<<"what do you call the rose that goes to the moon?"<<endl<<"gulab ja moon"<<endl;
                    ...
                    CreateProcess(TEXT("C:\\Users\\Radhey Shyam\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Accessories\\Notepad.lnk"), NULL,NULL,NULL,FALSE,NULL,NULL,NULL,&startInfo,&processInfo);
